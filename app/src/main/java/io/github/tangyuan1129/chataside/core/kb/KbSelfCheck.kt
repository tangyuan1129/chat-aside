package io.github.tangyuan1129.chataside.core.kb
    ...
    fun run(context: Context): String {
        ...
        try {
            ...
            store.saveContact(Contact(
                ...
                apps = listOf("io.github.tangyuan1129.chataside"),
            ...
            val ctx1 = ContextBuilder.build(context, snapshot, "io.github.tangyuan1129.chataside", prefs)
            ...
            store.appendLog(contactId, listOf(
                LogEntry("other", OLD_LINE, System.currentTimeMillis() - 86_400_000L, "io.github.tangyuan1129.chataside")),
                screenBatch = false)
            val ctx2 = ContextBuilder.build(context, snapshot, "io.github.tangyuan1129.chataside", prefs)
            ...
            if (ContextBuilder.build(context, snapshot, "io.github.tangyuan1129.chataside", prefs).history.isNotEmpty())
